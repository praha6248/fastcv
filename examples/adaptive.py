...
mean_result = fastcv.adaptive_threshold(img_tensor, max_value, 0, 0, block_size, C)
gauss_result = fastcv.adaptive_threshold(img_tensor, max_value, 1, 0, block_size, C)
